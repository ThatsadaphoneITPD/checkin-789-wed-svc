...
import { CreateUnitInput, createUnitSchema } from '@/utils/validators/create-unit.schema';
import { PiBuildingOfficeFill } from "react-icons/pi";

export default function CreateUnit(defaultdata: any) {
  ...
  const FormCreate = (
    <Form<CreateUnitInput> id="createExportForm" resetValues={reset} validationSchema={createUnitSchema} onSubmit={onSubmit} className="p-fluid" >
