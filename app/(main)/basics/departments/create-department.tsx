...
import { CreateDepartmentInput, createDepartmentSchema } from '@/utils/validators/create-department.schema';
import { PiBuildingOfficeFill } from "react-icons/pi";

export default function CreateDepatment(defaultdata: any) {
  ...
  const FormCreate = (
    <Form<CreateDepartmentInput> id="createExportForm" resetValues={reset} validationSchema={createDepartmentSchema} onSubmit={onSubmit} className="p-fluid" >
